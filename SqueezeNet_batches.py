...
def train_model(model, criterion, optimizer, train_files, val_files, num_epochs=10, batch_size=64):
...
model, accuracy, precision, recall, f1 = train_model(model, criterion, optimizer, train_files, val_files, num_epochs=10, batch_size=64)
